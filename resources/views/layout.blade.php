...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4 shadow sticky-top">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">Autókereskedés</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="{{ route('cars.index') }}">Hirdetések</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('cars.create') }}">Új hirdetés</a></li>
                    @auth
                    ...
                    @else
                        ...
                        <li class="nav-item"><a class="nav-link" href="/reg">Regisztráció</a></li>
                    @endauth
                </ul>
            </div>
        </div>
    ...
    <footer class="bg-light text-center py-3 mt-5 border-top">
        <small>&copy; {{ date('Y') }} Autókereskedés</small>
    </footer>
